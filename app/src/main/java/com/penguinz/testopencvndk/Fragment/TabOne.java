...
public class TabOne extends Fragment implements SurfaceHolder.Callback , Camera.PreviewCallback{
...
//                super.onPostExecute(aVoid);
                if(result == 1){
                    ...
                    ImageView iv = (ImageView) rootView.findViewById(R.id.result_image);
